...
Mais le principe de *JeAS* est justement d'*inverser la relation entre le serveur d'application et l'application*, vous permettant de ne packager que les fonctionnalités du server d'application requises par votre application.
