...
* Eclipse MicroProfile :
	...
	** Eclipse MicroProfile Releases and associated implementation: https://wiki.eclipse.org/MicroProfile/Implementation +
	-> Ce site indique également les implémentations ayant passé le TCK de MicroProfile
...
Concernant la notion de sidecar proxy, voir ce site, https://istio.io/docs/concepts/what-is-istio/, section "why use Istio?" :
...
Voir également cette définition de ce qu'est un sidecar proxy : https://www.lemagit.fr/definition/Proxy-side-car
