...
On vous a parlé de création de microservices avec stack Spring et MicroProfile, mais d'autres solutions sont possibles, comme l'usage d'Istio. +
Rentrer dans le détail serait l'objet d'une présentation à part, mais on peut rapidement en dire ceci : DEVELOPPER RAPIDEMENT
