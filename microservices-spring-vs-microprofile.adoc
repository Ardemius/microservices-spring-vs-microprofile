...
larger global customer base also comes global competition.
----
...
* Voir également l1 p18 pour une description de que l'environnement des microservices doit garantir.
* ET SURTOUT VOIR L'EXCELLENTE l1 p27 avec le schéma associé !!!! (à reprendre ?)

* rappeler la notion d'infrastructure immutable ? (l1 p25)
