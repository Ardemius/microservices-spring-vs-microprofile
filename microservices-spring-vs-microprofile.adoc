...
* Comparaison entre Spring Boot / Cloud et MicroProfile :
	...
	** Pour une comparaison de 2 jours de workshops pour bâtir une application microservices, l'un avec MicroProfile, l'autre avec Spring, voir : https://www.oxiane.com/voxxeddays-microservices/
...
ap19 - 20 : les principales caractéristiques
...
Faire un schéma global sur la modèle de celui de Susane KAISER lors du Voxxed Days microservices 2018

ON PLACE LES 15 20 min de pause ICI ! 

4. Passage à la pratique et demo
	** Présentation de la stack Spring Boot et Cloud
	** Présentation de la stack Microprofile
