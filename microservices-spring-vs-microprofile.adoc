...
* Cast Codeurs 207, vérifier, mais apparemment l'implémentation Thorntail de MicroProfile est en passe d'être abandonnée
...
Faire un schéma global sur la modèle de celui de Susanne KAISER lors du Voxxed Days microservices 2018

ON PLACE LES 15 20 min de pause ICI ! 

4. Passage à la pratique et demo
	...
	** Présentation exhaustive des technos que nous avons choisies pour les 2 stacks 
		**** Spring
		**** MicroProfile
			****** JAX-RS
			****** CDI
	** Demo
		**** QUE VA FAIRE L'APPLICATION DE DEMO !!!! +
		...
		1 gemme par feature de l'environnement microservices (on en a 6) +
...
5. Conclusion : récapitulatif des points communs / différences entre les 2 stacks
	** Spring est très vite "up to date" avec l'état de l'art du marché +
	...
	Avec cette question : Entre Sprint et Microprofile qui choisissez-vous ?
